...
//Set up program resources
{
    ...
    hostEdit.Create(&clientWin, "", 50, 15, 140, 20, WS_VISIBLE|WS_CHILD|ES_AUTOHSCROLL, WS_EX_CLIENTEDGE);
    portLabel.Create(&clientWin, "Port:", 200, 15, 35, 20, WS_VISIBLE|WS_CHILD);
    portEdit.Create(&clientWin, "", 235, 15, 70, 20, WS_VISIBLE|WS_CHILD);
    ...
    dataEdit.Create(&clientWin, "", 0, 0, 300, 20, WS_VISIBLE|WS_CHILD|WS_DISABLED);
...
//Send given data to the remote host
{
	string dataStr;
